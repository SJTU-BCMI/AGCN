...
class Model(nn.Module):
    def __init__(self, num_class=5,num_class_domain=15, num_point=62, num_person=1, A=None, graph_args=dict(), in_channels=5,c1=64, c2=64, c3=64, c4=128, c5=128, c6=256):
        ...
        self.fc_d = nn.Linear(c3, num_class_domain)
    ...
    def forward(self, x):
        ...
        x = x.mean(3).mean(1)
        out=self.fc(x)
        in_d=GradReverse.apply(x,0.001)
        out_d=self.fc_d(in_d)

        return out,out_d,A_private_list, A_public_list